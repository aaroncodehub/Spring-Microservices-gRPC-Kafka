...
public class BillingServiceGrpcClient {
    ...
    public BillingServiceGrpcClient(
            @Value("${billing.service.address:localhost}") String serverAddress, // NEED TO CONFIG AS DOCKER ENV VARIABLE- BILLING_SERVICE_ADDRESS: billing-service (docker host name)
